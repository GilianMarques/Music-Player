 ...
 */
public class PlaylistTracksMenu implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {
    ...
    public PlaylistTracksMenu(Track mTrack, ImageView ivArt, Playlist playlist, MenuActions.ActionsCallback callback) {
        this.mTrack = mTrack;
        this.ivArt = ivArt;
    ...
    public void onClick(View view) {
        ...
        menu.getMenu().removeItem(R.id.popup_song_delete);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.remove_from_playlist:
                new MenuActions(mActivity, mTrack).removeFromPlaylist(playlist, new MenuActions.ActionsCallback() {
                    @Override public void trackRemovedFromPlaylist(Track mTrack) {
                        callback.trackRemovedFromPlaylist(mTrack);
