 ...
 */
public class ArtistsFragmentTracksAdapter extends AnimatedRvAdapter {
    private ArrayList<Track> mTracks;
    private Callback callback;
    private LayoutInflater inflater;

    public ArtistsFragmentTracksAdapter(Activity mActivity) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        mHolder.ivMenu.setOnClickListener(
                new TracksMenu(mTrack, mHolder.ivAlbumArt).setCallback(menuCallback));
