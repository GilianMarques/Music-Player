 ...
 */
public class TracksMenu implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {
    ...
    TracksMenu(Track mTrack, ImageView ivArt) {
        this.mTrack = mTrack;
        this.ivArt = ivArt;
        mActivity = App.binder.get().getActivity();
    }

    public TracksMenu setCallback(MenuActions.ActionsCallback callback) {
    ...
    public void onClick(View view) {
        ...
        menu.getMenu().removeItem(R.id.popup_song_goto_artist);
